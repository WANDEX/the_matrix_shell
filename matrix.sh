...
get_opt() {
    ...
    SHORT=bc:dhlstu
    LONG=binary,custom:,digits,help,lower,special,testing,upper
...
get_chars() {
    letters="$binary_v$digits_v$lower_v$upper_v$special_v$custom_v"
...
main() {
    ...
    sleep 0.04
    keypress="`cat -v`"
    done | awk -v letters="$letters" "$awkscript"
